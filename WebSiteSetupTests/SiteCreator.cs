...
namespace WebSiteSetupTests
{
    public class SiteCreator
    {
        ...
        public void Setup(string webSitePath)
        {
            // perform the authentication
            this.Credentials =
                TokenCredentialHelper<MyPersonalConfiguration>.GetCredentials();
            ...
            settingsResult.AppSettings.Add("STORAGE_CONNECTION_STRING", 
                this.StorageAccountConnectionString);
            ...
            this.WebSiteManagementClient.WebSites.UpdateConfiguration(
                ...
                new WebSiteUpdateConfigurationParameters
                {
                    ...
                    DefaultDocuments = settingsResult.DefaultDocuments
                });
        }
